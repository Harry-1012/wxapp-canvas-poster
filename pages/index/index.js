...
Page({
  data: {
    cardInfo: {
      avater: "https://temp-customs-1251903635.cos.ap-chengdu.myqcloud.com/2019/sgxsc_huangzong/res/5329500_141723_1.png", //需要https图片路径
      qrCode: "https://ihogo-1251903635.file.myqcloud.com/qin/%E4%BD%9C%E5%93%81/qrCode/mininote.jpg", //需要https图片路径
      TagText: "小姐姐", //标签
      Name: '小姐姐', //姓名
      Position: "程序员鼓励师乌拉",
      Mobile: "1888888888", //手机
      price: "￥88.88", //公司
    }
  },
  ...
  sharePosteCanvas: function(avaterSrc, codeSrc) {
    ...
    wx.createSelectorQuery().select('#canvas-container').boundingClientRect(function(rect) {
      ...
      if (cardInfo.price) {
        ...
        let [contentLeng, contentArray, contentRows] = that.textByteLength(cardInfo.price, CONTENT_ROW_LENGTH);
        ctx.setTextAlign('left');
